...
if __name__ == "__main__":
    ...
    if control == "shap batch":
        ...
        all_post = {0: post_imbalanced_duplicate, 1: post_imbalanced_smote, 2: post_imbalanced_focus}
        ...
        if args.current_post != "all":
            ...
            cols_mean, cols_std = batch_run_rand_seed_chunk(feature_cols_name, raw_size, traina_size, 
                                                                    trainfull_size, traina_num, rand_seed_set, cols_base, 
                                                                    current_data_path, current_save_path, target, method, traina_half_name, data_name=data_name, metric=metric, current_post=current_post)
